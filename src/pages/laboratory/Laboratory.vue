...
const { fetchLaboratories, storeLaboratory, updateLaboratory, deleteLaboratory, selectedLabFilter } = labStore;
const { computers } = storeToRefs(cstore);
const { fetchComputers, fetchNoLabComputers, assignLabToComputer } = cstore;
    ...
    <AuthenticatedLayout>
         <div class="py-4 max-w-7xl mx-auto sm:px-4 bg-white">
            <!-- Header Section -->
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
                    ...
                    <div class="flex items-center mt-4 sm:mt-0">
                        <Button
                            @click="openAddModal"
                            class="inline-flex items-center gap-2 px-3 py-2 bg-blue-600 text-white text-sm font-medium rounded-md hover:bg-blue-700 focus:ring-4 focus:ring-blue-200 transition-all duration-200 shadow-sm"
                        >
            ...
            <div class="max-w-7xl mx-auto px-6 py-8">
                ...
                <div v-if="filterLaboratories.length > 0" class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                    <div
                        ...
                        class="group relative bg-white rounded-xl shadow-sm border border-gray-200 hover:shadow-lg hover:border-gray-300 transition-all duration-200 cursor-pointer overflow-hidden"
                    >
                        <!-- Card Header -->
                        <div class="p-6 pb-4">
                        ...
                        <div class="px-6 py-4 bg-gray-50 border-t border-gray-100 flex items-center justify-between">
                            <div class="flex items-center">
                                <div class="flex items-center">
                                    <div :class="{
                                        ...
                                        'bg-green-500': lab.status === 'active',
                                        'bg-red-500': lab.status === 'inactive',
                            ...
                            <Button
                                ...
                                class="text-xs px-3 py-1.5 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors font-medium"
                            >
                                Assign PCs
                            </Button>
                        </div>
                ...
                <div v-else class="text-center py-16">
                    <div class="max-w-md mx-auto">
                        ...
                        <Button
                            @click="openAddModal"
                            class="inline-flex items-center gap-2 px-3 py-2 bg-blue-600 text-white text-sm font-medium rounded-md hover:bg-blue-700 transition-colors"
                        >
                            <PlusIcon class="h-4 w-4" />
                            Add Laboratory
                        </Button>
            ...
            <Modal :show="populateModal" @close="populateModal = false">
                <div class="bg-white rounded-xl shadow-2xl w-full max-w-4xl mx-auto relative overflow-hidden">
                    <!-- Modal Header -->
                    ...
                    <div class="px-8 py-6 bg-gray-50 border-t border-gray-200 flex justify-between items-center">
                        ...
                        <div class="flex gap-3">
                            ...
                            <Button
                                ...
                                class="px-6 py-2 text-sm bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                            >
            ...
            <Modal :show="isModalOpen" @close="isModalOpen = false">
                <div class="bg-white rounded-xl shadow-2xl w-full max-w-lg mx-auto relative">
                    <!-- Modal Header -->
                    <div class="px-8 py-6 bg-gray-50 border-b border-gray-200">
                    ...
                    <div class="px-8 py-6">
                        <div class="space-y-6">
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">
                                    Laboratory Code <span class="text-red-500">*</span>
                                </label>
                                <input
                                    v-model="newLab.code"
                                    type="text"
                                    required
                                    placeholder="Enter laboratory code (e.g., LAB-001)"
                                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm font-mono transition-colors"
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    rows="3"
                                    placeholder="Enter laboratory description (optional)"
                                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm transition-colors resize-none"
                                ></textarea>
                            </div>
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm bg-white transition-colors"
                                >
                                    <option value="active">Active</option>
                                    <option value="inactive">Inactive</option>
                                    <option value="maintenance">Maintenance</option>
                    ...
                    <div class="px-8 py-6 bg-gray-50 border-t border-gray-200 flex justify-end gap-3">
                        ...
                        <Button
                            ...
                            type="submit"
                            class="px-6 py-2 text-sm bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors font-medium"
                        >
                            {{ selectedLab ? 'Update Laboratory' : 'Create Laboratory' }}
                        </Button>
                    </div>
                </div>
            </Modal>
